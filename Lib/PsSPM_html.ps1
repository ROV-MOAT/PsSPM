...
<script>
    ...
    function showNotification(message) {
        ...
        notification.style.cssText = ' position: fixed; bottom: 20px; right: 20px; background: green; color: white; padding: 10px 20px; border-radius: 5px; animation: fadeOut 2s forwards; ';
        document.body.appendChild(notification);
    
        setTimeout(() => notification.remove(), 2000);
    }
</script>
<div style="border: 2px solid #ddd; border-radius: 5px; background-color: #6d8196; padding: 10px;"><span><font color="white">This page was automatically generated $(Get-Date) by PowerShell SNMP printer monitoring (<a style='text-decoration: none; color: white;' href='https://github.com/ROV-MOAT/PsSPM' target='_blank'>PsSPM</a>).</font></span></div>
<p></p>
